...
export const adminNavItems: NavItem[] = [
  { href: "/dashboard", label: "Dashboard", icon: Home, description: "Overview of all activities", exact: true },
...
export const teacherNavItems: NavItem[] = [
  ...
  { href: "/attendance", label: "Attendance", icon: Clock, description: "Track student attendance" },
