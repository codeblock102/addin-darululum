...
export function TeacherActivityTab({ teacherId }: TeacherActivityTabProps) {
  const [period, setPeriod] = useState<"7days" | "30days" | "3months" | "all">(
    "30days",
  );
      ...
      for (let i = 0; i < 15; i++) {
        ...
        if (timestamp >= cutoffDate) {
          ...
          mockActivities.push({
            ...
            entity: activityType.type !== "login"
              ? `${activityType.type}-entity-${i}`
              : undefined,
          });
        }
      }
          ...
          <Card>
            <CardContent className="pt-6 text-center">
              ...
              <p className="text-muted-foreground">
                No activity records found for this teacher in the selected time
                period.
              </p>
            </CardContent>
          </Card>
