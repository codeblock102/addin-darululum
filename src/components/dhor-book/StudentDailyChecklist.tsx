...
export function StudentDailyChecklist(
  { studentId: _studentId, date, entries = [] }: StudentDailyChecklistProps,
) {
    ...
    <Card>
      <CardHeader>
        <CardTitle className="text-base">
          Daily Progress - {format(date, "MMM d, yyyy")}
        </CardTitle>
      </CardHeader>
      <CardContent>
        <div className="space-y-2">
          <div className="flex items-center space-x-2">
            ...
            <Label
              htmlFor="sabaq"
              className={hasSabaqEntry ? "" : "text-muted-foreground"}
            >
              Sabaq (Main Lesson)
            </Label>
          </div>
          ...
          <div className="flex items-center space-x-2">
            ...
            <Label
              htmlFor="sabaq-para"
              className={hasSabaqParaEntry ? "" : "text-muted-foreground"}
            >
              Sabaq Para (Reading)
            </Label>
          </div>
          ...
          <div className="flex items-center space-x-2">
            ...
            <Label
              htmlFor="dhor1"
              className={hasDhor1Entry ? "" : "text-muted-foreground"}
            >
          ...
          <div className="flex items-center space-x-2">
            ...
            <Label
              htmlFor="dhor2"
              className={hasDhor2Entry ? "" : "text-muted-foreground"}
            >
