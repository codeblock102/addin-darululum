    ...
    return (
      <Card className="p-8 text-center">
        <p className="text-gray-500">
          No progress entries found for this student.
        </p>
      </Card>
    );
  }
            ...
            {progress.map((entry) => (
              <TableRow key={entry.id}>
                ...
                <TableCell>
                  <span
                    className={`px-2 py-1 rounded-full text-xs ${
                      entry.memorization_quality === "excellent"
                        ? "bg-green-100 text-green-800"
                        : entry.memorization_quality === "good"
                        ? "bg-blue-100 text-blue-800"
                        : entry.memorization_quality === "average"
                        ? "bg-yellow-100 text-yellow-800"
                        : entry.memorization_quality === "needsWork"
                ...
                <TableCell>
                  ...
                  {entry.teacher_notes && (
                    <div
                      className="max-w-[200px] truncate text-xs text-blue-600 mt-1"
