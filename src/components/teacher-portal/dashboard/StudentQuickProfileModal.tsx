...
import { Book, CalendarDays, Phone, UserRound } from "lucide-react";
...
export const StudentQuickProfileModal = (
  { student, open, onOpenChange }: StudentQuickProfileModalProps,
) => {
        ...
        <div className="space-y-5">
          ...
          <div className="pt-4 flex gap-2">
            ...
            <Button
              variant="outline"
              className="flex-1"
              onClick={handleStudentProfileOpen}
            >
              Full Profile
            </Button>
          </div>
