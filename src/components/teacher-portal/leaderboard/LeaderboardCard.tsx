...
import { CheckSquare, Filter, RefreshCw, Trophy } from "lucide-react";
...
export const LeaderboardCard = (
  { teacherId, className = "" }: LeaderboardCardProps,
) => {
      ...
      <CardHeader className="pb-3">
        <div className="flex items-start sm:items-center justify-between gap-3 sm:gap-0 flex-col sm:flex-row">
          <div className="flex flex-col">
            ...
            <CardDescription>
              Track your students' progress and achievement
            </CardDescription>
          </div>
      ...
      <CardContent>
        <Tabs defaultValue="all" className="w-full">
          <TabsList className="grid w-full grid-cols-3">
            <TabsTrigger value="all" onClick={() => setSubjectTab("all")}>
              All
            </TabsTrigger>
            <TabsTrigger value="sabaq" onClick={() => setSubjectTab("sabaq")}>
              Sabaq
            </TabsTrigger>
            <TabsTrigger
              value="sabaqPara"
              onClick={() => setSubjectTab("sabaqPara")}
            >
              Sabaq Para
            </TabsTrigger>
          </TabsList>
