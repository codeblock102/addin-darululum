...
BEGIN
  ...
  -- ── 2. Upsert classes ───────────────────────────────────────
  -- Deterministic IDs: (substring(md5('DUM_<NAME>'),1,8)||'-'||substring(md5('DUM_<NAME>'),9,4)||'-'||substring(md5('DUM_<NAME>'),13,4)||'-'||substring(md5('DUM_<NAME>'),17,4)||'-'||substring(md5('DUM_<NAME>'),21,12))::uuid
  ...
  VALUES (
    (substring(md5('DUM_KG'),1,8)||'-'||substring(md5('DUM_KG'),9,4)||'-'||substring(md5('DUM_KG'),13,4)||'-'||substring(md5('DUM_KG'),17,4)||'-'||substring(md5('DUM_KG'),21,12))::uuid,
    'KG', 'Kindergarten', 'KG', 'active', 25,
    ARRAY['monday','tuesday','wednesday','thursday','friday'],
    array_remove(ARRAY[v_safiyyah, v_karima, v_afaf], NULL),
    ARRAY(SELECT * FROM jsonb_array_elements(jsonb_build_array(
  ...
  INSERT INTO classes (id, name, subject, section, status, capacity, days_of_week, teacher_ids, time_slots)
  VALUES (
    (substring(md5('DUM_GRADE1'),1,8)||'-'||substring(md5('DUM_GRADE1'),9,4)||'-'||substring(md5('DUM_GRADE1'),13,4)||'-'||substring(md5('DUM_GRADE1'),17,4)||'-'||substring(md5('DUM_GRADE1'),21,12))::uuid,
  ...
  INSERT INTO classes (id, name, subject, section, status, capacity, days_of_week, teacher_ids, time_slots)
  VALUES (
    (substring(md5('DUM_GRADE2'),1,8)||'-'||substring(md5('DUM_GRADE2'),9,4)||'-'||substring(md5('DUM_GRADE2'),13,4)||'-'||substring(md5('DUM_GRADE2'),17,4)||'-'||substring(md5('DUM_GRADE2'),21,12))::uuid,
  ...
  INSERT INTO classes (id, name, subject, section, status, capacity, days_of_week, teacher_ids, time_slots)
  VALUES (
    (substring(md5('DUM_GRADE2ES'),1,8)||'-'||substring(md5('DUM_GRADE2ES'),9,4)||'-'||substring(md5('DUM_GRADE2ES'),13,4)||'-'||substring(md5('DUM_GRADE2ES'),17,4)||'-'||substring(md5('DUM_GRADE2ES'),21,12))::uuid,
  ...
  INSERT INTO classes (id, name, subject, section, status, capacity, days_of_week, teacher_ids, time_slots)
  VALUES (
    (substring(md5('DUM_GRADE3ES'),1,8)||'-'||substring(md5('DUM_GRADE3ES'),9,4)||'-'||substring(md5('DUM_GRADE3ES'),13,4)||'-'||substring(md5('DUM_GRADE3ES'),17,4)||'-'||substring(md5('DUM_GRADE3ES'),21,12))::uuid,
  ...
  INSERT INTO classes (id, name, subject, section, status, capacity, days_of_week, teacher_ids, time_slots)
  VALUES (
    (substring(md5('DUM_GRADE4'),1,8)||'-'||substring(md5('DUM_GRADE4'),9,4)||'-'||substring(md5('DUM_GRADE4'),13,4)||'-'||substring(md5('DUM_GRADE4'),17,4)||'-'||substring(md5('DUM_GRADE4'),21,12))::uuid,
  ...
  INSERT INTO classes (id, name, subject, section, status, capacity, days_of_week, teacher_ids, time_slots)
  VALUES (
    (substring(md5('DUM_GRADE4ES'),1,8)||'-'||substring(md5('DUM_GRADE4ES'),9,4)||'-'||substring(md5('DUM_GRADE4ES'),13,4)||'-'||substring(md5('DUM_GRADE4ES'),17,4)||'-'||substring(md5('DUM_GRADE4ES'),21,12))::uuid,
  ...
  INSERT INTO classes (id, name, subject, section, status, capacity, days_of_week, teacher_ids, time_slots)
  VALUES (
    (substring(md5('DUM_GRADE5ES'),1,8)||'-'||substring(md5('DUM_GRADE5ES'),9,4)||'-'||substring(md5('DUM_GRADE5ES'),13,4)||'-'||substring(md5('DUM_GRADE5ES'),17,4)||'-'||substring(md5('DUM_GRADE5ES'),21,12))::uuid,
  ...
  INSERT INTO classes (id, name, subject, section, status, capacity, days_of_week, teacher_ids, time_slots)
  VALUES (
    (substring(md5('DUM_GRADE5'),1,8)||'-'||substring(md5('DUM_GRADE5'),9,4)||'-'||substring(md5('DUM_GRADE5'),13,4)||'-'||substring(md5('DUM_GRADE5'),17,4)||'-'||substring(md5('DUM_GRADE5'),21,12))::uuid,
  ...
  INSERT INTO classes (id, name, subject, section, status, capacity, days_of_week, teacher_ids, time_slots)
  VALUES (
    (substring(md5('DUM_GRADE6ES'),1,8)||'-'||substring(md5('DUM_GRADE6ES'),9,4)||'-'||substring(md5('DUM_GRADE6ES'),13,4)||'-'||substring(md5('DUM_GRADE6ES'),17,4)||'-'||substring(md5('DUM_GRADE6ES'),21,12))::uuid,
  ...
  INSERT INTO classes (id, name, subject, section, status, capacity, days_of_week, teacher_ids, time_slots)
  VALUES (
    (substring(md5('DUM_GRADE6'),1,8)||'-'||substring(md5('DUM_GRADE6'),9,4)||'-'||substring(md5('DUM_GRADE6'),13,4)||'-'||substring(md5('DUM_GRADE6'),17,4)||'-'||substring(md5('DUM_GRADE6'),21,12))::uuid,
  ...
  INSERT INTO classes (id, name, subject, section, status, capacity, days_of_week, teacher_ids, time_slots)
  VALUES (
    (substring(md5('DUM_SEC13'),1,8)||'-'||substring(md5('DUM_SEC13'),9,4)||'-'||substring(md5('DUM_SEC13'),13,4)||'-'||substring(md5('DUM_SEC13'),17,4)||'-'||substring(md5('DUM_SEC13'),21,12))::uuid,
